...
<html>
	...
	<body>
		...
		<div class="container-fluid" role="main">
			...
			<g:form class="form-horizontal" url="[resource:locataireInstance, action:'delete']" method="DELETE">
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<g:link class="btn btn-default edit" action="edit" resource="${locataireInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
